...
import static algorithm.binarysearch.BinarySearch.*;
...
public class BinarySearchTest {
    ...
    @Test
    @DisplayName("测试 JDK 中的 binarySearch")
    public void test5() {
        int[] a = {2, 5, 8};
        int target = 4;
    ...
    @Test
    @DisplayName("测试 binarySearchLeftmost 找不到返回 -1")
    public void test6() {
    ...
    @Test
    @DisplayName("测试 binarySearchRightmost 找不到返回 -1")
    public void test7() {
        int[] a = {1, 2, 4, 4, 4, 5, 6, 7};
